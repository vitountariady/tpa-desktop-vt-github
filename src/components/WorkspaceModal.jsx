...
const WorkspaceModal = (props) => {
    ...
    function addWorkspace(e){
        // console.log("uid user yang ditambah: "+ props.uid);
        e.preventDefault();
    ...
    return ( <div style={{background:'rgba(0,0,0,0.5)'}} className="z-20 fixed top-0 left-0 flex w-full min-h-full justify-center items-center">
