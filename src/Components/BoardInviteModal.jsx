...
const BoardInviteModal = (parameter) => {
    ...
    const sendInvite = (id) =>{
        updateDoc(doc(db,'notifications',id),{
            boardinvite: arrayUnion(parameter.board.id)
        })
    }
            ...
            if(user===undefined){
                ...
                getDoc(doc(db,'notifications',user.id)).then((notifications)=>{
                    if(!notifications.exists()){
                        ...
                        console.log(parameter.board.data().members)
                        if(parameter.board.data().members.includes(user.id)){
                            setShowWarning('Invited user is already a member')
                        }else if(notifications.data().boardinvite.includes(parameter.board.id)){
